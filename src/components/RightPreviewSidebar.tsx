...
const RightPreviewSidebar: React.FC<RightPreviewSidebarProps> = ({
  ...
  return (
    <aside className="h-screen w-[360px] flex-shrink-0 border-l bg-background">
...
const PreviewCard: React.FC<{ link: Link }> = ({ link }) => {
  return (
    <a
      ...
      className="group rounded-xl border bg-card p-3 shadow-sm hover:shadow-md transition-shadow"
    >
