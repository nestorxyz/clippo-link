      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="animate-fade-in">
          ...
          <p className="mt-6 text-lg text-muted-foreground">
            DoryAI is your personal link assistant, powered by AI. Just drop a
            link in the chat. Tell DoryAI what it’s about. Done — it’s
            remembered, tagged, and ready to find later.
          </p>
        ...
        >
          <div className="relative p-8 rounded-full bg-card border">
            ...
            <div
              className="absolute -inset-4 rounded-full bg-primary/5 -z-20 animate-pulse-subtle"
