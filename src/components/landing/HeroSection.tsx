      ...
      <div className="z-10">
        ...
        <div className="animate-fade-in" style={{ animationDelay: '300ms' }}>
          <p className="mt-4 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
            Save links by chatting. Your AI assistant organizes them instantly — with context, tags, and memory.
          </p>
        </div>

        <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{ animationDelay: '500ms' }}>
          <Link to="/auth">
            <Button size="lg" className="w-full sm:w-auto animate-pulse-subtle">Try Clippo</Button>
          </Link>
        ...
        <div className="mt-20 max-w-md mx-auto space-y-3 animate-fade-in" style={{ animationDelay: '700ms' }}>
          <div className="flex items-start gap-3 animate-message-in" style={{ animationDelay: '900ms' }}>
          ...
          <div className="flex items-start gap-3 justify-end animate-message-in" style={{ animationDelay: '1100ms' }}>
            <div className="bg-primary/20 border border-primary/50 p-3 rounded-lg text-left">
              <p className="text-sm">Saved to 🏋️ Geekwear — tags: gym, anime, toji</p>
            </div>
